...
int main()
{
	...
	cin >> c;
	cout << setw(53) << setfill(p) << p; //setw(int n) Ц установить ширину пол€ вывода в n символов;setfill(int n) Ц символ-заполнитель;
	printf("   %c \n", c); // печатать. —пецификаци€ преобразовани€ %c Ц символ;
